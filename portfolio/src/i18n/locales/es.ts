export default {
    translations: {
        ...
        fullstackDeveloper: 'Desarrollador de Software',
        ...
        stefaniniDescription: 'Responsable de desarrollar el Front End de los proyectos del equipo Gauge utilizando React, Next, Vue y Nuxt como stack principal, tanbién un ocasional desarrolamiento backend con Python y Django.',
