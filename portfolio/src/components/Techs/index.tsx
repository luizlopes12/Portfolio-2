import "./style.scss";
import reactTechsIcon from "/react-techs-icon.svg";
import vueTechsIcon from "/vue-techs-icon.svg";
import nodeTechsIcon from "/node-techs-icon.svg";
import mongoTechsIcon from "/mongo-techs-icon.svg";
import postgresTechsIcon from "/postgres-techs-icon.svg";
import muiTechsIcon from "/mui-techs-icon.svg";
import sassTechsIcon from "/sass-techs-icon.svg";
import techsNameLine from "/techs-name-line.svg";
import configIcon from "/config-icon.svg";
import gitBgIcon from "/git-bg-icon.svg";
import sassBgIcon from "/sass-bg-icon.svg";
import bgCheeseIllustration from "/bg-cheese-illustration.svg";
import postgreBgIcon from "/postgre-bg-icon.svg";
